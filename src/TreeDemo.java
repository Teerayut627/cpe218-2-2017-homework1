...
import java.awt.GridLayout;
    ...
    public class TreeDemo extends JPanel
        ...
        public void valueChanged(TreeSelectionEvent e) {
            ...
            Homework1.Node result = (Homework1.Node)nodeInfo;
            Homework1.inorder(result);

            htmlPane.setText(result.data.toString());
...
//            }
        ...
        private void createNodes(DefaultMutableTreeNode top, Homework1.Node n) {
            ...
            if(n.data == '+' || n.data == '*' ||  n.data == '-' ||  n.data == '/'){
                ...
                DefaultMutableTreeNode Sai = new DefaultMutableTreeNode(n.left);
                top.add(Sai);
                createNodes(Sai,n.left);
            }
            if(n.data == '+' || n.data == '*' ||  n.data == '-' ||  n.data == '/'){
                DefaultMutableTreeNode Kwa = new DefaultMutableTreeNode(n.right);
                top.add(Kwa);
                createNodes(Kwa,n.right);
            }
